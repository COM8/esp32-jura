...
AbstractAddressableMessage::AbstractAddressableMessage(const Jid from, const Jid to, std::string&& id) : AbstractMessage(std::move(id)), from(std::move(from)), to(std::move(to)) {}
//---------------------------------------------------------------------------
}  // namespace esp32jura::xmpp::messages
//---------------------------------------------------------------------------
